...
{
    // tourne doucement pour rechercher la ligne

    moteur(MOTEUR_GAUCHE, ARRIERE, 22);

    moteur(MOTEUR_DROIT, ARRIERE, 22);
}
...
void loop()
{
    ...
    else if(valeur >= 45 && valeur <= 75)
    {
        ...
        // si marron detecte longtemps
        // alors stop

        if(millis() - tempsMarron > 800)
        {
            stopRobot();
        }
        else
    ...
    // ==========================================
    // RESET DETECTION MARRON
    // ==========================================

    if(valeur < 45 || valeur > 75)
    {
        tempsMarron = 0;
    }
